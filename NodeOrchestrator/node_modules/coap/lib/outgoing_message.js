...
if (0) {
//      send(that, helpers.genAck(request)) // HD - originally this is not commented

      // we are no more in piggyback
//      that._packet.confirmable = true // HD - originally this is not commented
//      that._packet.ack = false // HD - originally this is not commented

      // we need a new messageId for the CON
      // reply
//      delete that._packet.messageId // HD - originally this is not commented
}
      that._ackTimer = null
